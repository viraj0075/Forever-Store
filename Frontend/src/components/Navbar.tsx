...
export default function Navbar() {
    ...
    return (
        ...
        >
                ...
                <div className="flex items-center justify-between py-4 font-medium">
                        ...
                        {navLinks.map((item) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <span
                                        className={`absolute -bottom-1 left-0 h-0.5 bg-black transition-all duration-300 ${active ? "w-full" : "w-0 group-hover:w-full"
                                            }`}
                                    />
                                </Link>
                            );
                    ...
                    <div className="flex items-center gap-5 md:gap-8">
                        ...
                        <button
                            ...
                            className="rounded-full p-2 transition-colors hover:bg-gray-200 cursor-pointer"
                        >
                            <img
                        ...
                        <div className="group relative z-40">
                            <button
                                ...
                                className="rounded-full p-1 transition-colors hover:bg-gray-200 cursor-pointer"
                            >
                                <img
                            ...
                            <div className="invisible absolute right-0 top-full pt-4 opacity-0 transition-all duration-300 group-hover:visible group-hover:opacity-100 hover:bg-gray-200 cursor-pointer">
            ...
            {/* Search Overlay */}
            <div
                className={`absolute top-full left-0 right-0 z-40 px-4 sm:px-6 lg:px-8 max-w-[1500px] mx-auto overflow-hidden bg-white transition-all duration-300 ${searchOpen
            ...
            >
                <div className="flex items-center justify-center gap-3">
                    <div className="flex w-full max-w-2xl items-center rounded-full border border-gray-300 bg-gray-50 px-5 py-2.5 transition-all focus-within:bg-white focus-within:ring-2 focus-within:ring-gray-200">
                        <img
                            src={assets.search_icon}
                            className="w-5 opacity-60 cursor-pointer mr-3"
                            alt="Search bar"
                            loading="lazy"
                        />
                        <input
            ...
            {/* Mobile Sidebar */}
            <div
                className={`fixed inset-0 z-[100] bg-white transition-transform duration-300 md:hidden ${menuOpen ? "translate-x-0" : "translate-x-full"
                    }`}
            >
                <div className="flex h-full flex-col">
                    ...
                    <div className="flex items-center justify-between border-b border-gray-200 px-4 py-3">
                        <button
                            ...
                            className="group flex items-center gap-2 text-gray-600 transition-colors hover:text-black cursor-pointer"
                        >
                            <HiChevronLeft className="h-5 w-5 transition-transform group-hover:-translate-x-1" />
                            <span className="text-sm font-bold">BACK</span>
                        </button>

                        <img src={assets.logo} className="w-20 cursor-pointer" alt="Forever logo" loading="lazy" />
                    ...
                    <div className="mt-auto bg-gray-50 p-6">
                        ...
                        <Link
                            to="/login"
                            onClick={() => setMenuOpen(false)}
                            className="block w-full rounded-xl border-2 border-gray-200 py-3 text-center text-sm font-bold text-gray-700 transition-colors hover:bg-white"
                        >
                            Log In
                        </Link>
                    </div>
